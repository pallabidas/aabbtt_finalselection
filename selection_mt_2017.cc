...
int main(int argc, char** argv){
    ...
    for(int i = 0; i < n; i++){
        ...
        if (sample=="embedded"){
            ...
            trigger2027 = (matchEmbFilter_Mu20Tau27_2017_1 && matchEmbFilter_Mu20Tau27_2 && pt_1>21 && pt_1<25 && pt_2>32 && fabs(eta_2)<2.1);
        }
        ...
        if (sample!="data_obs" && sample!="embedded"){
            ...
            if (mymu.Pt()>25){
                ...
                sf_MC *= m_trg_MuTau_Mu20Leg_desy_ratio * t_trg_pog_deeptau_medium_mutau_ratio;
            }
