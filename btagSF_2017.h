double GetSF2017(int WP, float x, int flavour, int syst){
...
double bTagEventWeight2017(int nBtaggedJets, float bjetpt_1, int bjetflavour_1, float bjetpt_2, int bjetflavour_2, int WP, int syst, int nBTags)
{
  ...
  */
  ...
  double weight = 0;
  if(nBtaggedJets==1){
    double SF = GetSF2017(WP,bjetpt_1,bjetflavour_1,syst);
    ...
    double SF1 = GetSF2017(WP,bjetpt_1,bjetflavour_1,syst);
    double SF2 = GetSF2017(WP,bjetpt_2,bjetflavour_2,syst);
