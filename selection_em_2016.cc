...
int main(int argc, char** argv){
    ...
    else if(sample == "gghbbtt40"){xs = 0.1*48.58*0.1322; weight = luminosity*xs/N;}
    else if(sample == "VBFbbtt40"){xs = 0.1*3.782*0.1908; weight = luminosity*xs/N;}
