...
double GetSF_M(int WP, float x, int flavour, int syst){
      if (fabs(flavour)==4 or fabs(flavour)==5){
        ...
        if (syst==-1){
               if (x < 30) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.12064050137996674;
               else if (x<50) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.042138919234275818;
               else if (x < 70) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.03711806982755661;
               else if (x < 100) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.036822021007537842;
               else if (x < 140) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.034397732466459274;
               else if (x < 200) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.0362386554479599;
               else if (x < 300) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.044985830783843994;
               else if (x < 600) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.064243391156196594;
               else return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))-0.097131341695785522;
        }
        if (syst==1){ 
               if (x < 30) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))+0.12064050137996674;
               else if (x<50) return (0.561694*((1.+(0.31439*x))/(1.+(0.17756*x))))+0.042138919234275818;
