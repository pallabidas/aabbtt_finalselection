...
xaxis=["m^{vis}_{#tau#tau} (GeV)","e pT (GeV)","#mu pT (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{b#tau#tau} (GeV)","e pT (GeV)","#mu pT (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{b#tau#tau} (GeV)","m^{vis}_{bb#tau#tau} (GeV)","e pT (GeV)","#mu pT (GeV)"]
