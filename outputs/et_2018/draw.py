...
#categories=["m_btt_atleast1b","m_btt_1b","m_bbtt_2b","mt_tau1_atleast1b","mt_tau2_atleast1b","mt_tau1_1b","mt_tau2_1b","mt_tau1_2b","mt_tau2_2b","dz_atleast1b","dz_1b","dz_2b"]
categories=["m_tt_b1","m_tt_b2","m_tt_b3","m_tt_b4","m_tt_b5","m_tt_b6","m_tt_c1","m_tt_c2","m_tt_c3","m_tt_c4","m_tt_c5"]
#categories=["mt_tau1_b1","mt_tau2_b1","dz_b1","mt_tau1_b2","mt_tau2_b2","dz_b2","mt_tau1_b3","mt_tau2_b3","dz_b3","mt_tau1_b4","mt_tau2_b4","dz_b4","mt_tau1_b5","mt_tau2_b5","dz_b5","mt_tau1_b6","mt_tau2_b6","dz_b6"]

#xaxis=["m^{vis}_{#tau#tau} (GeV)","e pT (GeV)","#tau_{h} pT (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{b#tau#tau} (GeV)","e pT (GeV)","#tau_{h} pT (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{b#tau#tau} (GeV)","m^{vis}_{bb#tau#tau} (GeV)","e pT (GeV)","#tau_{h} pT (GeV)"]
#xaxis=["m^{vis}_{b#tau#tau} (GeV)","m^{vis}_{b#tau#tau} (GeV)","m^{vis}_{bb#tau#tau} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","D_{#zeta} (GeV)","D_{#zeta} (GeV)"]
xaxis=["m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)","m^{vis}_{#tau#tau} (GeV)"]
#xaxis=["m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)","m_{T}(e,#vec{p}^{miss}_{T}) (GeV)","m_{T}(#tau,#vec{p}^{miss}_{T}) (GeV)","D_{#zeta} (GeV)"]
